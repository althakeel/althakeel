...
const Galary1 = () => {
  ...
  const images = [
    'https://res.cloudinary.com/dm8z5zz5s/image/upload/v1748766870/S6_iexlg5.webp',
    'https://res.cloudinary.com/dm8z5zz5s/image/upload/v1748764749/S5_vmce6b.webp',
    'https://res.cloudinary.com/dm8z5zz5s/image/upload/v1748764748/S4_ajgbzg.webp',
    'https://res.cloudinary.com/dm8z5zz5s/image/upload/v1748764747/S2_giye6v.webp',
  ];

  const mobileImage = 'https://res.cloudinary.com/dm8z5zz5s/image/upload/v1749129080/M4_bgrlhj.webp';
